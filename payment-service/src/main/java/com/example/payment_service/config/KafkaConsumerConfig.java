...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String,BookingCreatedEvent> bookingCreatedEventConsumerFactory(){
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String,BookingCreatedEvent>> bookingCreatedEventKafkaListenerContainerFactory(){

        ConcurrentKafkaListenerContainerFactory<String,BookingCreatedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();

        factory.setConsumerFactory(bookingCreatedEventConsumerFactory());
